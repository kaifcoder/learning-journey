...
const CourseIdPage = async ({ params: { courseId } }: Props) => {
  ...
  return (
    <div className="flex flex-col items-start max-w-xl mx-auto my-16">
      ...
      <div className="flex p-4 mt-5 border-none rounded-lg bg-secondary">
        <Info className="w-12 h-12 mr-3 text-blue-400" />
        <div>
          We generated chapters for each unit based on the subtopics you
          provided. Look over them and click the button to confirm and continue.
        </div>
      </div>
